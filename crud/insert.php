...
//Cria conexão
$conn = new mysqli($servername,$username,$password,$dbname);//verifica a conexão

//Verifica a conexão
if($conn->connect_error){
    dia("Conexão falhou:".$conn->connect_error);
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $stmt = $conn->prepare("INSERT INTO usuarios(nome,email,senha) VALURES(?,?,?)");
